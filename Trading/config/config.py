...
SP500_GENERATED_PATH = GENERATED_PATH / "sp500"
SP500_WEIGHTS_GENERATED_PATH = GENERATED_PATH / "sp500_weights.json"
...
SP500_VALUATION_PATH = DOCS_PATH.joinpath("sp500_valuation.json")
