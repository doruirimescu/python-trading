...
def setup_parameters():
    ...
    return (N_CANDLES, SHOULD_REINVEST, DESIRED_CASH_INVESTED, SYMBOLS_TO_TEST)
...
if __name__ == "__main__":
    ...
    (N_CANDLES, SHOULD_REINVEST, DESIRED_CASH_INVESTED, SYMBOLS_TO_TEST) = setup_parameters()
    ...
    for symbol in SYMBOLS_TO_TEST:
        ...
        try:
            history_days = client.get_last_n_candles_history(Instrument(symbol, "1D"), N_CANDLES)
        ...
        print(f"A number of {len(trades)} trades were made during {N_CANDLES} days")
